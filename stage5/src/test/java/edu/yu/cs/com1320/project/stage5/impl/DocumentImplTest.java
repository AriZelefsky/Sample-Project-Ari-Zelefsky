...
public class DocumentImplTest {
    ...
    void constructorsTest(){
        ...
        assertThrows(IllegalArgumentException.class, ()-> new DocumentImpl(null, "Hi"));
        assertThrows(IllegalArgumentException.class, ()-> new DocumentImpl(null, byteArray));
        assertThrows(IllegalArgumentException.class, ()-> new DocumentImpl(blankUri, "Hi"));
        ...
        assertThrows(IllegalArgumentException.class, ()-> new DocumentImpl(uri, (String) null)); //Specifically calling the txt constructor with null text
        ...
        assertThrows(IllegalArgumentException.class, ()-> new DocumentImpl(uri, ""));
    ...
    void getWordsTest(){
        ...
        DocumentImpl textDoc2 = new DocumentImpl(uri, ".i i i i i i i @#$i ()(i)("); //Should be considered a singular word
        //check that only SPACES seperate words, not tabs nor new lines
        DocumentImpl textDoc3 = new DocumentImpl(uri, " 1\ndoesnot\tcount\nbconly\nspaces\tnottabs\nornewlines \n \n 2 3 4 5 6 7 8 \n \n 9 ");
        DocumentImpl textDoc4 = new DocumentImpl(uri, "che*$ck1   m---y2 e.x.a.c.t3 !w@or#d$s4");
        DocumentImpl textDoc5 = new DocumentImpl(uri, "words4 exact3 my2 check1"); //Regardless of order and nonletter/digit chars, should be same as above
        DocumentImpl textDoc6 = new DocumentImpl(uri, "hi theRe how Are you!!!");
        DocumentImpl textDoc7 = new DocumentImpl(uri, "hi there how are you!!!");
        DocumentImpl textDoc8 = new DocumentImpl(uri, "!@#$$%^^&&**()_+=-{][]:',./?>,.");
    ...
    @Test
    void wordCountTest(){
        DocumentImpl textDoc5 = new DocumentImpl(uri, "hi .hi h/i that is three his)");
