...
public class DocumentPersistenceManager implements PersistenceManager<URI, Document> {
    ...
    /**
     * Serialization method that assumes all provided URIs will begin with http://
     * @param uri
     * @param val
     * @throws IOException
     */
    ...
    public void serialize(URI uri, Document val) throws IOException {
        ...
        File jsonFile = new File(baseDir, uri.toString().substring(7) + ".json"); //Leaving %20 as is, not as a space character, and assuming that all URIs will be provided as http://...
    ...
    public Document deserialize(URI uri) throws IOException {
        ...
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader(jsonFile))){
            ...
            while(true){
                ...
                // returns len: the amount (8192, or less if end of file was reached in middle, or -1 if up to end of file before reading any chars)
    ...
    public boolean delete(URI uri) throws IOException {
        File jsonFile = new File(baseDir, uri.toString().substring(7) + ".json"); //Alternatively could have used uri.getHost() and uri.getRawPath()
